...
@section('titulo', 'Dashboard Asesorias')
@section('contenido')
    <h1 class="text-3xl font-bold text-center mt-5">Asesorias</h1>
    <!-- SECCIÓN QUE CONTIENE LA TARJETA Y LA GRÁFICA -->
    <div class="flex flex-wrap justify-center gap-5 p-5 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6 w-full graficas">
            <!-- Gráfica de barras a la izquierda -->
            <div class="flex flex-col lg:flex-row items-stretch w-full lg:w-auto h-full">
                <div id="barChartContainer"
                    class="seccion-projects p-12 relative flex flex-col min-w-0 mb-4 lg:mb-0 break-words bg-gray-50 w-full shadow-lg rounded-xl font-sans h-full">
                    <canvas id="barChart" class="mt-5"
                        style="display: block; box-sizing: border-box; height: 100%; width: 400px;"></canvas>
                </div>
            </div>
            <!-- Componente administrator.section-projects a la derecha -->
            <div class="flex flex-col lg:flex-row items-stretch gap-5 w-full h-full">
