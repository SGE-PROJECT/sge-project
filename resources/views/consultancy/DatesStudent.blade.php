...
@section('contenido')
    ...
    <main class="vista_asesorias">
        @if (!$advisor)
            <h2 style="color: #293846; font-size: 24px; font-weight: bold; text-align: left; width: 80%; margin-top:50px;">
                Opss... parece que aun no tienes un asesor designado...</h2>
            <h2 style="color: #293846; font-size: 24px; font-weight: bold; text-align: left; width: 80%;">Lo sentimos, puedes
                contactar con servicios estudiantiles para que se te asigne un asesor, numero: 235 103 5581.</h2>
        @endif
