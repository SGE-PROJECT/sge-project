        ...
        <div class="bg-white p-8 rounded-lg shadow-xl">
            ...
            <div class="flex flex-col md:flex-row justify-center md:items-start m-8">
                ...
                <div class="m-6 md:mb-0 profile-picture-container" onclick="openModal()">
                    <img alt="Profile Picture" src="{{ asset('images/avatar.jpg') }}"
            ...
            <div class="border-t border-blueGray-200 m-8 pt-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    @for ($i = 1; $i <= 6; $i++)
                        <div
                            class="bg-gray-100 rounded-lg p-4 flex flex-col justify-between transition duration-300 ease-in-out transform hover:shadow-lg">
