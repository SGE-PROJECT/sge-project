...
<div class="w-auto h-56 shadow-lg hover:shadow-2xl transition duration-200 ease-in-out bg-white rounded-sm relative">
    <a class="group w-full p-5 flex flex-col" href="equipos">
    <div id="container-teams" class="w-full h-full min-h-[224px]"></div>
  ...
  <script>
    Highcharts.chart('container-teams', {
        credits: {
        ...
        series: [{
            ...
            innerSize: '60%',
            data: [
            { name: 'Equipos totales', y: 135, color: '#03a6a6' },
            { name: '', y: 78 , color: '#a1a1a1' },
            ]
        }]
    });
    </script>
