...
@section('contenido')
    ...
    <div class="flex items-end align-middle">
        ...
        <button type="submit"
            class="relative bg-teal-500 text-white px-4 py-2 ml-6 mr-5 rounded hover:bg-teal-600 transition-colors h-full"
                ...
                <tbody>
                    @foreach ($anteprojects as $anteproject)
                            <tr>
                                ...
                                <td class="py-4 text-sm text-black">{{ $anteproject->fullname_student }}</td>
                                <td class="py-4 text-sm text-black">{{ $anteproject->group_student}}</td>
                                <td class="py-4 text-sm text-black">Example</td>
