         ...
         <div class="contenido m-10">
            ...
            <div>
                <div class="form-control">
                    ...
                    <label>
                        <span style="transition-delay:0ms">E</span><span style="transition-delay:50ms">d</span><span style="transition-delay:100ms">a</span><span style="transition-delay:150ms">d</span>
                    </label>
                </div>
            </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="flex justify-center">
                        <div class="w-32 h-32 bg-gray-200 rounded-full overflow-hidden">
                            <img id="preview-image" src="https://via.placeholder.com/150" alt="Preview" class="object-cover">
                        </div>
                    </div>
                    <br>
                    <label for="foto-input" class="w-full bg-teal-500 text-white px-6 py-2 rounded hover:bg-teal-600 transition-colors">
                        Seleccionar foto
                    </label>
            ...
            <button type="submit" class=" bg-teal-500 text-white px-6 py-2 rounded hover:bg-teal-600 transition-colors">Agregar Usuario</button>
