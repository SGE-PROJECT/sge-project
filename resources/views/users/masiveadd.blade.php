...
<a  href="{{ route('users.masiveadd.export')}}" class="Btn_divisions modal-button ml-8 p-2.5 bg-teal-500 text-white  rounded hover:bg-teal-600 transition-colors">Descargar Excell</a>
<form action="{{ route('users.masiveadd.import') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <input type="file" name="file" required>
    <button type="submit" class="Btn_divisions modal-button ml-8 p-2.5 bg-teal-500 text-white rounded hover:bg-teal-600 transition-colors">Subir Excel</button>
</form>
