...
<head>
  ...
  @vite('resources/js/tableteams.js')
  @vite('resources/js/tableusuers.js')
      ...
      <ul class="mt-4 scroll2 overflow-y-scroll">
        ...
        <li class="mb-1 group relative z-2">
          ...
          <ul class="hidden absolute z-20 left-full top-0 w-48 bg-[#394C5F] text-white submenu rounded-md">
            <li class=" ">
              <a href="/usuarios" class=" text-white text-sm flex items-center hover:bg-[#2F4050] p-1 rounded-md ">
