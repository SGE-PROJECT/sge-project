                ...
                <form action="" method="post">
                    ...
                    <div class="container-inputs">
                        <div class="inputs-group-1">
                            ...
                            <input class="inputs-add-books" type="text" id="name-client" name="name-client"
                                placeholder="Ingresa tu nombre">

                            <label class="labels-add-books" for="title-book">Título del libro:</label>
                            <input class="inputs-add-books" type="email" id="title-book" name="title-book"
                                placeholder="Ingresa el título del libro">

                            <label class="labels-add-books" for="author">Autor:</label>
                            <input class="inputs-add-books" type="text" id="author" name="author"
                        ...
                        <div class="inputs-group-2">
                            ...
                            <input class="inputs-add-books" type="text" id="id-client" name="id-client"
                                placeholder="Ingresa tu matrícula">

                            <label class="labels-add-books" for="edition">Edición:</label>
                            <input class="inputs-add-books" type="text" id="edition" name="edition"
                                placeholder="Ingresa la edición del libro">

                            <label class="labels-add-books" for="date-book">Fecha:</label>
                            <input class="inputs-add-books" type="date" id="date-book" name="date-book">
                        </div>
                    </div>
