    ...
    <main class="flex justify-evenly pt-10 rounded font-poppins">
        @forelse ($book as $bk)
            <div class=" mx-10 h-auto img-book-student flex-wrap   rounded grid grid-cols-1 items-center">
                ...
                <h1
                    class="  rounded-t w-full  bg-gradient-to-r from-[#00ab84] to-[#00e7b1] h1-book-student  font-semibold flex items-center justify-center  gap-2 text-white py-2 px-4 ">
                    ...
                    </svg> Libro<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                        <path fill="currentColor"
                            d="M6.75 22q-1.125 0-1.937-.763T4 19.35V5.4q0-.95.588-1.7t1.537-.95L16 .8v16l-9.475 1.9q-.225.05-.375.238T6 19.35q0 .275.225.463T6.75 20H18V4h2v18zM7 16.575l2-.4V4.225l-2 .4z" />
                    </svg></h1>
                    ...
                    <div class=" grid-book   px-3    w-full   justify-center items-center content-start  ">
                        <div class="   h-full flex justify-center items-center">
                            ...
                            <div class=" book xl:min-h-[480px]   xl:min-w-[260px] max-w-[260px]  duration-300">
                                <div
                                    class=" inf-book mt-3 flex flex-col pl-12 max-h-[320px] min-h-[300px] min-w-[225px] overflow-auto items-center">

                                    <h1
                                        class="subtitle-book font-semibold bg-gradient-to-r from-teal-500   to-teal-500 inline-block text-transparent bg-clip-text">
                                        Descripción:</h1>
                                    <p class=" font-normal text-slate-700  ">{{ $bk->description }}</p>
                                </div>
                                <div class="cover">
                                    <img class="img-book-student  h-full w-full rounded" src="{{ $bk->image_book }}"
                        ...
                        <div class=" mt-0 ">
                            <h1 id="title-book-student"
                                class="   title-book-student  text-clip mb-4 font-bold  text-balance text-center bg-gradient-to-r from-slate-600  to-slate-500 inline-block text-transparent bg-clip-text">
                                {{ $bk->title }}</h1>
                            <div class=" grid grid-cols-2 gap-2 justify-items-center items-center  text-center">
                                ...
                                <div class=" ">
                                    @if ($bookCollaborative->count() > 1)
                                        <h1
                                            class="bg-gradient-to-r from-teal-500 font-semibold  to-teal-500 inline-block text-transparent bg-clip-text subtitle-book mb-1">
                                            Colaboradores:</h1>
                                        @foreach ($bookCollaborative as $bkcol)
                                            <span class=" flex items-center mb-2 gap-1"><svg class=" text-slate-400"
                                                ...
                                                <p class=" font-medium  bg-blue-400 text-white rounded-full p-[3px] px-2  ">
                                                    {{ $bkcol->name }}</p>
                                            </span>
                                        @endforeach
                                    @else
                                ...
                                <div class=" mt-3 flex flex-col">
                                    ...
                                    <h1
                                        class="subtitle-book  bg-gradient-to-r font-semibold from-teal-500  to-teal-500 inline-block text-transparent bg-clip-text">
                                        Editorial:</h1>
                    ...
                    <div class=" rounded-lg">
                        ...
                        <div class=" grid grid-cols-2 bg-white  rounded-b-lg">
                            ...
                            <div class=" grid grid-cols-1 gap-0 rounded-br-lg">
                                <div class=" text-slate-700  text-balance text-center text-3xl pt-2 mt-16  ">¡Vaya Parece que no
                                    tienes agregado ningun libro!
                                </div>
                                @if ($permiso)
                                    <dv class=" text-center text-balance flex justify-center items-center h-fit">
                                        <a class=" rounded bg-teal-500 text-white p-2 font-bold"
                                            href="{{ route('añadir.libros') }}">Agregar</a>
                                    </dv>
                                @endif
                            </div>
