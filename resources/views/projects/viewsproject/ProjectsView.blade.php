    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 p-4">
        @foreach ($Projects as $project)
            ...
            <div class="block rounded-lg bg-white text-center text-surface shadow-secondary-1 ">
                <div class="text-gray-600 border-b-2 border-neutral-100 px-6 py-3 ">
                    <div class="rating mr-5 text-sm">
                        ...
                        <label class="mr-2 font-bold text-sm" for="score">Puntaje: {{ $averageScore }}</label>
                    </div>
                </div>
                <div class="p-6">
                    ...
                    <h2 class="mb-2 mr-4 text-gray-600 font-bold"><i class='nf nf-fa-group mt-[-12px] mr-2 text-[#00ab84]'></i>
                        Integrantes
                    </h2>
                ...
                <div class="border-t-2 border-neutral-100 px-6 py-3 text-surface/75 flex items-center space-x-4">
                    <button class="flex items-center space-x-2 Btn font-semibold leading-tight text-sm text-white">
