        ...
        <form id="projectForm" action="{{ route('envproyecto') }}" method="POST" class="space-y-4">
                    ...
                    <select name="project_status_area" class="w-full border-2 border-gray-300 p-3 text-sm"
                        ...
                        @foreach ($businessAdvisors as $advisor)
                            <option value="{{ $advisor->id }}" data-name="{{ $advisor->name }}"
                                ...
                                data-email="{{ $advisor->email }}">{{ $advisor->name }}</option>
                        @endforeach
            ...
            <div id="otrosCampos" style="display: none;">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div class="relative group overflow-hidden rounded-lg bg-white border border-gray-200 mt-0 mb-4">
                        <div class="bg-gradient-to-r from-[#00ab84] to-[#2e9980] py-1 px-4">
                            <h2 class="text-xl font-semibold text-white mb-0">Número Teléfonico del Asesor Empresarial:
                            </h2>
                        </div>
                    ...
                    <div class="relative group overflow-hidden rounded-lg bg-white border border-gray-200 mt-0 mb-4">
                        <div class="bg-gradient-to-r from-[#00ab84] to-[#2e9980] py-1 px-4">
                            <h2 class="text-xl font-semibold text-white mb-0">Correo Electrónico del Asesor Empresarial:
                            </h2>
                        </div>
