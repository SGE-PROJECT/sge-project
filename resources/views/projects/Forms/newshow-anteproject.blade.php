        ...
        <form action="{{ route('projects.update', $proyecto->id) }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div class="relative group overflow-hidden rounded-lg bg-white  mt-0 mb-4">
                    ...
                    <input name="fullname_student" class="w-full border-2 bg-gray-100 border-gray-300 p-3 text-sm h-auto rounded-lg"
                ...
                <div class="relative group overflow-hidden rounded-lg bg-white  mt-0 mb-4">
                    ...
                    <input name="id_student" class="w-full border-2 bg-gray-100 border-gray-300 p-3 text-sm h-auto rounded-lg"
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div class="relative group overflow-hidden rounded-lg bg-white  mt-0 mb-4">
                    ...
                    <input name="group_student" class="w-full  border-2 bg-gray-100 border-gray-300 p-3 text-sm h-auto rounded-lg"
                ...
                <div class="relative group overflow-hidden rounded-lg bg-white mt-0 mb-4">
                    ...
                    <input name="email_student" class="w-full border-2 bg-gray-100 border-gray-300 p-3 text-sm h-auto rounded-lg"
                ...
                <div class="relative group overflow-hidden rounded-lg bg-white  mt-0 mb-4">
                    ...
                    <input name="phone_student" class="w-full border-2 bg-gray-100 border-gray-300 p-3 text-sm h-auto rounded-lg"
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div class="relative group overflow-hidden rounded-lg bg-white  mt-0 mb-4">
                    ...
                    <input name="company_name" class="w-full border-2 bg-gray-100 border-gray-300 p-3 text-sm h-auto rounded-lg"
                ...
                <div class="relative group overflow-hidden rounded-lg bg-white mt-0 mb-4">
                    ...
                    <input name="company_address" class="w-full border-2 bg-gray-100 border-gray-300 p-3 text-sm h-auto rounded-lg"
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div class="relative group overflow-hidden rounded-lg bg-white mt-0 mb-4" >
                    ...
                    <input name="name" class="w-full border-2 bg-gray-100 border-gray-300 p-3 text-sm h-auto rounded-lg"
                ...
                <div class="relative group overflow-hidden rounded-lg bg-white  mt-0 mb-4">
                    ...
                    <input name="position" class="w-full border-2 bg-gray-100 border-gray-300 p-3 text-sm h-auto rounded-lg"
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div class="relative group overflow-hidden rounded-lg bg-white  mt-0 mb-4">
                    ...
                    <input name="phone" class="w-full border-2 bg-gray-100 border-gray-300 p-3 text-sm h-auto rounded-lg"
                ...
                <div class="relative group overflow-hidden rounded-lg bg-white  mt-0 mb-4">
                    ...
                    <input name="email" class="w-full border-2 bg-gray-100 border-gray-300 p-3 text-sm h-auto rounded-lg"
            ...
            <div class="grid grid-cols-1 gap-4">
                <div class="relative group overflow-hidden rounded-lg bg-white mt-0 mb-4">
                    ...
                    <input name="name_project" class="w-full border-2 border-gray-300 p-3 text-sm h-auto rounded-lg"
            ...
            <div class="grid grid-cols-1 gap-4">
                <div class="relative group overflow-hidden rounded-lg bg-white ">
                    ...
                    <textarea name="general_objective" class="w-full border-2 border-gray-300 p-3 text-sm h-auto rounded-lg" placeholder="Redacta aqui..."
            ...
            <div class="grid grid-cols-1 gap-4">
                <div class="relative group overflow-hidden rounded-lg bg-white ">
                    ...
                    <textarea name="problem_statement" class="w-full border-2 border-gray-300 p-3 text-sm h-auto rounded-lg" placeholder="Redacta aqui..."
            ...
            <div class="grid grid-cols-1 gap-4">
                <div class="relative group overflow-hidden rounded-lg bg-white">
                        <h2 class="text-xl font-semibold text-teal-800 mb-0">Justificacion: Debe manifestarse de
                            ...
                            la
                            investigación:</h2>
                    <textarea name="justification" class="w-full border-2 border-gray-300 p-3 text-sm h-auto rounded-lg" placeholder="Redacta aqui..."
            ...
            <div class="mt-8 flex justify-center text-center space-x-2">
                <button class=" font-bold bg-blue-500 text-white  px-6 py-2 rounded hover:bg-blue-700 transition-colors">
