            ...
            <div class="w-full md:w-1/4 px-4">
                ...
                <div class="bg-white max-w-sm rounded overflow-hidden shadow-lg h-full relative card_divisions gap-4">
                    ...
                    <div class="absolute top-0 right-0 mt-2 mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor"
                            class="w-6 h-6 text-white hover:scale-110 transition-transform duration-300 ease-in-out">
                    ...
                    <div class="absolute bottom-0 right-0 mt-3 mb-2 mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            class="w-6 h-6 text-red-500 hover:scale-110 transition-transform duration-300 ease-in-out">
