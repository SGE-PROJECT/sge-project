    ...
    <div class="max-w-lg mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        @enderror
            ...
            <div class="mb-4">
                ...
                <input id="contact_phone" type="number" placeholder="Teléfono" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('contact_phone') border-red-500 @enderror" name="contact_phone" value="{{ $company->contact_phone }}" required autocomplete="contact_phone">
            </div>
