...
.group.selected > a {
    background-color: #394C5F; /* Fondo oscuro para el elemento seleccionado */
...
.group.selected > a::before {
    ...
    top: 0;
    bottom: 0;
    width: 0.25rem; /* Ancho del borde */
    border-radius: 0.25rem 0 0 0.25rem; /* Redondeo de las esquinas del borde */
}
...
.group.selected  {
    ...
    list-style: none;
    border-left: 0.25rem solid #03A696; /* Borde izquierdo para los elementos desplegables */
    margin-left: -0.25rem; /* Ajuste para el margen izquierdo */
}
...
.sidebar-contracted {
        ...
        /* Tooltip estilo para mostrar el nombre al hacer hover */
        .nav-icon:hover + .nav-tooltip {
            visibility: visible;
            opacity: 1;
        }

        /* Tooltip para el nombre del ícono */
        .nav-tooltip {
            visibility: hidden;
            width: 120px;
        ...
        /* Estilo para el ícono seleccionado */
...
<body class="text-gray-800 font-inter">
 <!--sidenav-->
<div class="fixed left-0 top-0 w-64 h-full bg-[#2F4050] p-4 z-50 sidebar-menu transition-transform scroll">
  <a href="#" class="flex items-center pb-4 border-b border-b-gray-800">
      <img class="w-[150px]" src="logo_sge.png" alt="">
  </a>
  <ul class="mt-4">
      <!-- ADMIN Section -->
      <span class="text-gray-400 font-bold nav-text">ADMIN</span>
      <li class="sidebar-item">
        <a href="#" class="tooltip-container">
            <i class='bx bxs-dashboard mr-3 text-lg icon'></i>
            <span class="nav-text text-sm">Dashboard</span>
            <span class="tooltip-content">Dashboard</span>
        </a>
    </li>
    <!-- Repite para cada ítem en el sidebar -->
    
      <li class="mb-1 group">
          <a href="#" class="flex font-semibold items-center py-2 px-4 text-white hover:bg-[#394C5F] hover:text-gray-100 rounded-md">
      ...
      <li class="mb-1 group">
          <a href="#" class="flex font-semibold items-center py-2 px-4 text-white hover:bg-[#394C5F] hover:text-gray-100 rounded-md">
              ...
              <span class="nav-text text-sm">Usuarios</span>
          </a>
      </li>
      <li class="mb-1 group">
          <a href="#" class="flex font-semibold items-center py-2 px-4 text-white hover:bg-[#394C5F] hover:text-gray-100 rounded-md">
              <i class='bx bx-lock-open mr-3 text-lg'></i>
              <span class="nav-text text-sm">Roles y Permisos</span>
          </a>
      </li>

      <!-- ACADEMICO Section -->
      <span class="text-gray-400 nav-text font-bold">ACADÉMICO</span>
      <li class="mb-1 group">
          <a href="#" class="flex font-semibold items-center py-2 px-4 text-white hover:bg-[#394C5F] hover:text-gray-100 rounded-md">
              <i class='bx bx-buildings mr-3 text-lg'></i>
              <span class="nav-text text-sm">Divisiones</span>
          </a>
      </li>
      <li class="mb-1 group">
          <a href="#" class="flex font-semibold items-center py-2 px-4 text-white hover:bg-[#394C5F] hover:text-gray-100 rounded-md">
              <i class='bx bx-book-open mr-3 text-lg'></i>
              <span class="nav-text text-sm">Programas</span>
          </a>
      </li>
      <li class="mb-1 group">
          <a href="#" class="flex font-semibold items-center py-2 px-4 text-white hover:bg-[#394C5F] hover:text-gray-100 rounded-md">
              <i class='bx bx-folder-plus mr-3 text-lg'></i>
              <span class="nav-text text-sm">Proyectos</span>
          </a>
      </li>
...
<main class=" main-content-contracted w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
    <!-- navbar -->
    <div class="py-2 px-6 bg-[#f8f4f3] flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
       
      <button type="button" class="bg-[#03A696] text-lg text-white font-semibold sidebar-toggle">
...
sidebarToggle.addEventListener('click', function () {
    ...
    mainContent.classList.toggle('main-content-contracted');
        ...
        // Script para marcar como seleccionado un ítem del sidebar y mostrar su tooltip
        document.querySelectorAll('.sidebar-menu a').forEach(function(item) {
            item.addEventListener('click', function(e) {
                const previouslySelected = document.querySelector('.sidebar-menu .selected');
                ...
                // Mostrar el tooltip también cuando el ítem está seleccionado
