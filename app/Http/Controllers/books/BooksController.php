...
class BooksController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $libros = [
            ...
            ['imagen' => 'images/books/java-book.jpg', 'titulo' => "Programación orientada a objetos con Java", "descripcion" => "Sumérgete en el mundo de la programación orientada a objetos con este libro enfocado en Java, que ofrece una guía completa desde los fundamentos hasta las técnicas avanzadas, ideal para desarrolladores en busca de un dominio sólido en POO con este lenguaje.", 'editorial' => "Editorial - $id"],
